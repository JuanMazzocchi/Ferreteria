...
function modal(event){
    ...
    let version=event.currentTarget.getAttribute("version")

    let modal=document.getElementById("imagenModal2")
    let modalFullscr=document.getElementById("imagenModal2Fullscr")
     
    modal.setAttribute("src", "/media/img/"+id+".jpg?v="+version)
    modalFullscr.setAttribute("src", "/media/img/"+id+".jpg?v="+version)
